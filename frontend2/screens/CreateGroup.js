...
export default function CreateGroup() {
  ...
  const uploadPhoto = async () => {
    ...
    if (!nameGroup) {
      Alert.alert('Warning', "You need a name for the group!");
      return;
    }
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View style={{ flex: 1 }}>
            <Header title="New group!" toggleMenu={toggleMenu}></Header>
            ...
            <View style={styles.container}>
              ...
              {/* ----------------pick the name------------------- */}
              <Text style={styles.label}>Name of your group*: </Text>
              <TextInput style={[styles.input, { backgroundColor: 'white' }]} onChangeText={setnameGroup} value={nameGroup} placeholder="type the name" />
